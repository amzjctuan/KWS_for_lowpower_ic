...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tmp/retrain_logs_lyc/hd5_train_2words_8bit_mixup_16fea_bnnv3',
  ...
  parser.add_argument(
      ...
      default = 'happy,marvin',
      help='Words to use (others will be added to an unknown label)',)
  parser.add_argument(
      '--train_dir',
      type=str,
      default='tmp/speech_commands_train/hd5_train_2words_8bit_mixup_16fea_bnnv3',
