...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/home/zhangs/tensorflow-master/tensorflow/examples/speech/tmp/speech_dataset',
      help="""\
  ...
  parser.add_argument(
      '--output_audio_file',
      type=str,
      default='tmp/streaming_test_2.wav',
      help='File to save the generated test audio to.')
  parser.add_argument(
      '--output_labels_file',
      type=str,
      default='tmp/streaming_test_labels_2.txt',
