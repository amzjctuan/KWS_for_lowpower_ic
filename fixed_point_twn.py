  ...
  for training_step in xrange(start_step, training_steps_max + 1):
    ...
    if (training_step % FLAGS.eval_step_interval) == 0 or is_last_step:
      ...
      test_fingerprints, test_ground_truth = audio_processor.get_data_my(
        6000, 0, model_settings, 0.0, 0.0, 0, 'testing', sess)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tmp/retrain_logs_lyc/mfcc1words',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='tmp/speech_commands_train/mfcc1words',
