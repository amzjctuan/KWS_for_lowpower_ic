...
##############################################
  ...
  tnnbatch = tf.placeholder(tf.int32, name='tnnbatch')
    ...
    if (training_step % FLAGS.eval_step_interval) == 0 or is_last_step:
      ...
      final_summary,test_accuracy, conf_matrix = sess.run(
          ...
          feed_dict={
              ...
              istrain : False,
              tnnbatch: len(audio_processor.final_index['testing'])
          })
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tmp/retrain_logs_lyc/2words_test_dscnn_tnn',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='tmp/speech_commands_train/2words_test_dscnn_tnn',
