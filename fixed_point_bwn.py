...
###
  ...
  for training_step in xrange(start_step, training_steps_max + 1):
    ...
    #######       自动切换学习率      #######
    if training_step <6000+1:
        learning_rate_value = learning_rates_list[0]*0.04**(training_step/6000)
    else:
        learning_rate_value = learning_rates_list[0]*0.04    #0.015 12000
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      #default='/home/zhangs/tensorflow-master/tensorflow/examples/speech_lyc/tmp/data_over_300',
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tmp/retrain_logs_lyc/bnn_twowords',
