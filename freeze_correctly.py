...
def create_inference_graph(wanted_words, sample_rate, clip_duration_ms,
  ...
  words_list = input_data_filler.prepare_words_list_my(wanted_words.split(','))
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--start_checkpoint',
      type=str,
      default='tmp/speech_commands_train/l_ds_conv.ckpt-5000',
  ...
  parser.add_argument(
      '--output_file',
      type=str,
      default ='tmp/l_ds_conv5000new.pb',
