...
###
  ...
  for training_step in xrange(start_step, training_steps_max + 1):
    ...
    #######       自动切换学习率      #######
    if training_step <8000+1:
        learning_rate_value = learning_rates_list[0]*0.02**(training_step/8000)
    else:
    ...
    if training_step == training_steps_max:
        for i,bestacc in enumerate(best_acc_list):
            print_line += 'Best test accuracy before now = %.1f%% (N=%d)' % (best_acc_list[i] * 100,6882) + '  at step of ' + str(best_step_list[i]) + '\n'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      #default='/home/zhangs/tensorflow-master/tensorflow/examples/speech_lyc/tmp/KWSFeature/',
      #default='/home/zhangs/tensorflow-master/tensorflow/examples/speech_lyc/tmp/H5_diff_feature/',
      #default='/home/zhangs/zs_data_cut/tmp/data_agc/',
      #default='/home/zhangs/zs_data_cut/tmp/train_data',
      default='/home/zhangs/tensorflow-master/tensorflow/examples/speech_lyc/tmp/newfeature4/',
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tmp/retrain_logs_lyc/h5_dscnn_bnn',
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='tmp/speech_commands_train/h5_dscnn_bnn',
